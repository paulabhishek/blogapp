...
@if(Auth::guest())
    <p>Login to Comment  here <a href="{{ url('/login')}}" class="btn btn-outline-secondary me-2">Login</a></p>
@else
                ...
                <div class=" bg-white p-2 px-4">
                    <form method="POST" action="{{ action('CommentController@store') }}">
                        ...
                        <div class="  mt-4 mb-4">
                            ...
                            <textarea class="form-control" name="comment" required="required" placeholder="Add comment" rows="1"></textarea><br>
